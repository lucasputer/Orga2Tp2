...
char *archivo_out_c  =  "output/tiempos_solver_lin_solve_c_o3.out";
char *archivo_out_asm_1px  =  "output/tiempos_solver_lin_solve_asm_1px_o3.out";
char *archivo_out_asm_2px  =  "output/tiempos_solver_lin_solve_asm_2px_o3.out";
char *archivo_out_asm_opt  =  "output/tiempos_solver_lin_solve_asm_opt_o3.out";

int CANTIDADDIMENSIONES = 25;
int SALTO_MEDICION = 32;
int ITERACIONESDISTINTAS = 10;
int ITERACIONESIGUALES = 50;
